      ...
      {!isOpen && (
        ...
        >
          ...
          >
            ...
            <h1 className="font-serif text-4xl sm:text-5xl mt-4 text-rose-gold-dark tracking-wide">
          ...
          <div className="flex flex-col items-center justify-center grow w-full z-10 py-4">
            ...
            >
              ...
              <div className="mt-2 mb-4">
                <h2 className="font-sans font-semibold text-2xl text-rose-gold-dark tracking-wide wrap-break-word">
                  {guestName}
                </h2>
                {address && (
                  <p className="font-sans font-medium text-base text-rose-gold-dark wrap-break-word">
                    {address}
                  </p>
                )}
              </div>
