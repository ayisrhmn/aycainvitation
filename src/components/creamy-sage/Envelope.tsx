...
export default function Envelope({ onOpen, groomName, brideName }: EnvelopeProps) {
    ...
    <AnimatePresence>
      {!isOpen && (
        ...
        >
          ...
          >
            <span className="text-xs uppercase tracking-[0.3em] text-charcoal-muted">
              Undangan Pernikahan
            </span>
          ...
          <motion.div
            ...
            className="w-full max-w-sm p-8 text-center bg-white/70 backdrop-blur-md border border-rose-gold-light/40 rounded-2xl shadow-xl shadow-rose-gold-light/10 relative"
          >
            {/* Hiasan Frame Minimalis */}
            <div className="absolute inset-2 border border-rose-gold-light/20 rounded-xl pointer-events-none" />

            <p className="text-xs uppercase tracking-widest text-charcoal-muted font-sans mb-3">
            ...
            <p className="text-[11px] sm:text-xs text-charcoal-muted leading-relaxed font-sans px-2">
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center text-white">
                <MailOpen className="w-6 h-6 stroke-[1.5]" />
              </div>
            </button>

            <span className="text-xs tracking-widest text-charcoal font-medium animate-pulse">
              BUKA UNDANGAN
            </span>
          </motion.div>
