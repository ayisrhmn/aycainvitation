import { Button, WishCard } from '@/components/silver-serenity/atoms';
    ...
    <div className='relative px-4 py-40'>
      ...
      <div className='w-full relative z-10 px-4 py-4 bg-white/50 backdrop-blur-sm rounded-xl shadow-lg'>
        ...
        <form className='mb-8' onSubmit={handleSubmit}>
          <div className='mb-4'>
            <input
              className='shadow appearance-none border rounded-lg w-full py-2 px-3 text-slate-600 leading-tight focus:outline-none focus:shadow-outline'
              type='text'
              placeholder='Name'
              value={name}
          ...
          <div className='flex items-center justify-between mb-6'>
            <Button
              ...
              className='bg-slate-600 hover:bg-slate-600 text-white hover:text-white rounded-full transition duration-300 border-none'
              type='submit'
            >
              Send
            </Button>
        ...
        >
          {loading ? (
            <p className='text-sm text-center italic text-slate-600 opacity-60'>
              Loading wishes...
            </p>
          ) : (
            <>
