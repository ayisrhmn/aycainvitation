    ...
    <div className='text-center mb-10'>
      ...
      <div className='mb-8'>
        ...
        <div className='flex items-center justify-center space-x-4 -ml-3'>
          <div className='border-r-2 border-green-900'>
          ...
          <div className='border-l-2 border-green-900'>
      ...
      {!noLocation && (
        <>
          ...
          <div className='flex justify-center relative'>
            <Button
              className='rounded-full flex gap-2 items-center justify-center bg-green-900 border-none shadow-lg'
